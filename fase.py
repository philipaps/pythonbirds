...
class Fase():
    ...
    def adicionar_passaro(self, *passaros):
        ...
        :param passaros:
        """
        self._passaros.extend(passaros)#para adicionar os atores
    ...
    def calcular_pontos(self, tempo):
        ...
        pontos=[self._transformar_em_ponto(a) for a in self._passaros+self._obstaculos+self._porcos]#imprime pontos na tela
